      ...
      <section>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-6 col-lg-4">
            <a href="https://pruthi-shivin.github.io/MERNfullstack_tasks/" className="card-link">
          ...
          <div className="col-sm-12 col-md-6 col-lg-4">
            <a href="https://pruthi-shivin.github.io/js_bs_mernfullstack/" className="card-link">
