  ...
  return (
    <div>
      <section style={{ margin: "100px",marginTop:"10px" }}>
        ...
        <br />
        <br />
        <a href="https://github.com/pruthi-shivin" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light">
        ...
        <br />
        <br />
        <a href="https://www.linkedin.com/in/shivin-pruthi-07286b190/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light">
          <div style={{ display: "flex", alignItems: "center", width: "255px", height:"75px" }}>
